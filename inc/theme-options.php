        ...
        array(
            ...
            'theme_elements' => array(
                ...
                array(
                    ...
                    'subtitle'    => __( 'Header active menu background color ( #65C383 )', 'wisersites' ),
                    'heading'     => '',
                    'type'        => 'color_picker',
            ...
            'home_page' => array(
                ...
                array(
                    ...
                    'subtitle'    => __( 'Background for Custom header ( #1d8241 )', 'wisersites' ),
                    'heading'     => '',
                    'type'        => 'color_picker',
                    'id'          => 'custom_header_bg',
                    'default'     => '#1d8241',
                ...
                array(
                    ...
                    'subtitle'    => __( 'Background Gradient for Custom header ( #30ac5e )', 'wisersites' ),
                    'heading'     => '',
                    'type'        => 'color_picker',
                ...
                array(
                    ...
                    'subtitle'    => __( '"Learn more" button color ( #5aa349 )', 'wisersites' ),
                    'heading'     => '',
                    'type'        => 'color_picker',
...
function create_section_for_post_selectbox( $field, $value = '' ){
    ...
    if( !count($front_page_elements) ) $front_page_elements = array( 'null' );
    //i_print($value);
